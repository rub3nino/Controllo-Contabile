...
const CONTROLS: ControlDef[] = [
  ...
  },
  {
    ...
    hint: "Frequenza sotto soglia sulla popolazione caricata. Disattivato di default: peso proposto, non ancora nello standard Baker Tilly.",
  ...
  },
  {
    ...
    status: "assente",
    baker: "Estensione Quadra",
    hint: "Ancora assente nel motore. Da definire il pattern (77, 99, …) e una soglia minima di importo.",
    flagKeys: [],
    available: false,
    attivoKeys: [],
    pesi: [],
  ...
  },
  {
    ...
    status: "assente",
    baker: "Estensione Quadra",
    hint: "Ancora assente nel motore. Il conto è testo libero: una regola a 10 cifre andrebbe parametrizzata per gestionale.",
    flagKeys: [],
    available: false,
    attivoKeys: [],
    pesi: [],
